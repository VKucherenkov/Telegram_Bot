LEXICON_RU: dict[str, str] = {
    ...
    '/help': 'Вы можете сыграть в игру "Камень, ножницы, бумага"\n\nили '
             'почитать книгу Рэя Брэдбери "Марсианские хроники".\n\nЧтобы '
             'поиграть наберите /game, чтобы начать чтение наберите /book '
             'или нажмите соответствующую кнопку внизу',
